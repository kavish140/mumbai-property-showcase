        ...
        <div>
          ...
          <h2 className="font-display text-4xl font-semibold leading-tight md:text-5xl">
            ...
            <span className="bg-gradient-gold bg-clip-text text-transparent">
              property, capital, and law.
            </span>
          </h2>
          <p className="mt-6 text-lg text-primary-foreground/75">
            Most brokers sell. We advise. Combining a decade of Mumbai real estate with an
            established finance practice — and a legal arm opening soon — clients get one team that

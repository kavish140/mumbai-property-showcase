        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display text-4xl font-semibold md:text-5xl">
              Honest market breakdowns, every week.
            </h2>
            <div className="mt-5 inline-flex items-center gap-3 rounded-full border border-border bg-card px-4 py-2 text-sm shadow-card">
              ...
              <span>
                ...
                <span className="text-muted-foreground">subscribers and growing</span>
              </span>
            </div>
          </div>
          <Button
            asChild
            size="lg"
            className="bg-gradient-gold text-accent-foreground shadow-card hover:opacity-90"
          >

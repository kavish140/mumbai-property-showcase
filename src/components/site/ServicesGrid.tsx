...
const services = [
  {
    ...
    desc: "Apartments, villas, and bungalows across Mumbai's most desirable neighborhoods.",
  },
  {
    icon: Building,
    title: "Commercial Real Estate",
    desc: "Grade-A offices, retail frontage, and investment-ready commercial assets.",
  },
  {
    icon: TrendingUp,
    title: "Investment Advisory",
    desc: "Strategic property investment guidance backed by our finance expertise.",
  },
  {
    icon: Scale,
    title: "Legal & Finance Support",
    desc: "End-to-end title, loan, and contract support — soon a full legal practice.",
  },
];
      ...
      <div className="container">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Three disciplines, one team. Built for buyers and investors who want clarity at every
            step.
          </p>
        </div>

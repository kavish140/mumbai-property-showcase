      ...
      <div className="container grid gap-10 lg:grid-cols-[1.2fr_1fr]">
        <div>
          ...
          <p className="mt-4 max-w-lg text-muted-foreground">
            Whether you're buying, selling, or weighing an investment, we'll get back within one
            business day.
          </p>
          ...
          <Card className="border-border bg-gradient-navy text-primary-foreground shadow-card">
            <CardContent className="p-7">
              ...
              <p className="mt-2 text-sm text-primary-foreground/75">
                Fastest way to reach us. Reply within minutes during business hours.
              </p>
              <Button
                asChild
                size="lg"
          ...
          <Card className="border-border bg-card shadow-card">
            <CardContent className="space-y-3 p-7">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-foreground">+91 97571 90200</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Mail className="h-4 w-4 text-accent" />{" "}
                <span className="text-foreground">ganatraj@gmail.com</span>
              </div>
              <p className="pt-2 text-xs text-muted-foreground">
                Office: G-54 Saidham Shopping Plaza, P.K. Road, Mulund West, Mumbai — Mon to Sat,
                10am–7pm
              </p>
            </CardContent>
          </Card>

...
if (!supabaseUrl || !supabaseKey) {
  console.warn(
    "⚠️ Missing Supabase environment variables. Prerendering property pages will be skipped.",
  );
}
...
const routes = [
  ...
  },
  {
    ...
    description:
      "Meet the founder and learn about our multidisciplinary approach across property, capital, and law.",
    image: `${baseUrl}/og-image.jpg`,
  },
  {
    path: "/services",
    ...
    description:
      "Explore our services including residential sales, commercial leasing, legal advisory, and real estate finance.",
    image: `${baseUrl}/og-image.jpg`,
  },
  {
    path: "/contact",
    ...
    description:
      "Get in touch for property inquiries, legal assistance, or finance consultation in Mumbai.",
    image: `${baseUrl}/og-image.jpg`,
  },
  {
    path: "/properties",
  ...
  for (const property of properties) {
    routes.push({
      ...
      description: property.description
        ...
        : `Check out this ${property.bedrooms}BHK ${property.type} at ${property.location}.`,
